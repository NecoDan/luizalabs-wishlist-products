...
class WishlistServiceTest {
    ...
    void mustSaveANewWishlist() {
        ...
        when(jpaWishlistRepository.save(any(Wishlist.class))).thenReturn(wishlistSave);
        wishlistService.save(wishlistSave);

        verify(jpaWishlistRepository, times(1)).save(wishlistSave);
    ...
    void mustDeleteWishlistById() {
        ...
        verify(jpaWishlistRepository, times(1)).deleteById(id);
    }
    ...
    void shouldSearchWishlistById() {
        ...
        when(jpaWishlistRepository.findById(any(String.class))).thenReturn(Optional.of(wishlist));
        wishlistService.findById(id);

        verify(jpaWishlistRepository, times(1)).findById(id);
    ...
    void mustSearchAllWishlistsByClientIdAndProductId() {
        ...
        when(jpaWishlistRepository.findAllWishListClientIdAndProductId(anyString(), anyString()))
    ...
    void mustSearchAllWishlistsByClientId() {
        ...
        when(jpaWishlistRepository.findAllByClientId(anyString())).thenReturn(wishlists);
    ...
    void shouldSearchWishlistByIdReturningError() {
        ...
        when(jpaWishlistRepository.findById(anyString())).thenReturn(Optional.empty());
    ...
    void mustSearchAllWishlistsReturningError() {
        ...
        when(jpaWishlistRepository.findAll()).thenReturn(Collections.emptyList());
