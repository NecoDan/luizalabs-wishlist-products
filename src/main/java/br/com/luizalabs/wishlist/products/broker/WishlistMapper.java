...
public class WishlistMapper {
    ...
    public WishlistRequest toWishlistRequestFrom(ProductRequest productRequest) {
        return modelMapperConfig.modelMapper().map(productRequest, WishlistRequest.class);
    }
}
